...
function re1l3HotelR2() {
			...
			if ($('.3rdkid-R2hotel').val() >= '1'  &&  $('.2kid-R2hotel').val() >= '1'  &&  $('.1stkid-R2hotel').val() >= '1') ageDoneR2Hotel();
		}
function re1l4HotelR2() {
			if ($('.2kid-R2hotel').val() == '0') doAgeR2Hotel();
			if ($('.3rdkid-R2hotel').val() == '0') doAgeR2Hotel();
			if ($('.4rthkid-R2hotel').val() == '0') doAgeR2Hotel();
			else if ($('.4rthkid-R2hotel').val() >= '1'  &&  $('.3rdkid-R2hotel').val() >= '1'  &&  $('.2kid-R2hotel').val() >= '1'  &&  $('.1stkid-R2hotel').val() >= '1') ageDoneR2Hotel();
		}
function re1l5HotelR2() {
			...
			else if ($('.5kid-R2hotel').val() >= '1'  &&  $('.4rthkid-R2hotel').val() >= '1'  &&  $('.3rdkid-R2hotel').val() >= '1'  &&  $('.2kid-R2hotel').val() >= '1'  &&  $('.1stkid-R2hotel').val() >= '1') ageDoneR2Hotel();
		}
function re1l6HotelR2() {
			...
			else if ($('.6kid-R2hotel').val() >= '1'  &&  $('.5kid-R2hotel').val() >= '1'  &&  $('.4rthkid-R2hotel').val() >= '1'  &&  $('.3rdkid-R2hotel').val() >= '1'  &&  $('.2kid-R2hotel').val() >= '1'  &&  $('.1stkid-R2hotel').val() >= '1') ageDoneR2Hotel();
		}
...
function ageR3logic1hotel() {
	if ($('.selec-Children-hotelR3').val() >= '2'  &  $('.2kid-R3hotel').val() == '0') doAgeR3Hotel();
...
function re1l2HotelR3() {
	...
	else if ($('.2kid-R3hotel').val() >= '1'  &&  $('.1stkid-R3hotel').val() >= '1') ageDoneR3Hotel();
}
function re1l3HotelR3() {
			if ($('.2kid-R3hotel').val() == '0') doAgeR3Hotel();
			if ($('.3rdkid-R3hotel').val() == '0') doAgeR3Hotel();
			if ($('.3rdkid-R3hotel').val() >= '1'  &&  $('.2kid-R3hotel').val() >= '1'  &&  $('.1stkid-R3hotel').val() >= '1') ageDoneR3Hotel();
		}
...
function re1l4HotelR3() {
			...
			else if ($('.4rthkid-R3hotel').val() >= '1'  &&  $('.3rdkid-R3hotel').val() >= '1'  &&  $('.2kid-R3hotel').val() >= '1'  &&  $('.1stkid-R3hotel').val() >= '1') ageDoneR3Hotel();
		}
function re1l5HotelR3() {
			...
			else if ($('.5kid-R3hotel').val() >= '1'  &&  $('.4rthkid-R3hotel').val() >= '1'  &&  $('.3rdkid-R3hotel').val() >= '1'  &&  $('.2kid-R3hotel').val() >= '1'  &&  $('.1stkid-R3hotel').val() >= '1') ageDoneR3Hotel();
		}
function re1l6HotelR3() {
			...
			else if ($('.6kid-R3hotel').val() >= '1'  &&  $('.5kid-R3hotel').val() >= '1'  &&  $('.4rthkid-R3hotel').val() >= '1'  &&  $('.3rdkid-R3hotel').val() >= '1'  &&  $('.2kid-R3hotel').val() >= '1'  &&  $('.1stkid-R3hotel').val() >= '1') ageDoneR3Hotel();
		}
...
function ageR4logic1hotel() {
	if ($('.selec-Children-hotelR4').val() >= '2'  &  $('.2kid-R4hotel').val() == '0') doAgeR4Hotel();
...
function re1l2HotelR4() {
	...
	else if ($('.2kid-R4hotel').val() >= '1'  &&  $('.1stkid-R4hotel').val() >= '1') ageDoneR4Hotel();
}

function re1l3HotelR4() {
	if ($('.2kid-R4hotel').val() == '0') doAgeR4Hotel();
	if ($('.3rdkid-R4hotel').val() == '0') doAgeR4Hotel();
	if ($('.3rdkid-R4hotel').val() >= '1'  &&  $('.2kid-R4hotel').val() >= '1'  &&  $('.1stkid-R4hotel').val() >= '1') ageDoneR4Hotel();
}
...
function re1l4HotelR4() {
	...
	else if ($('.4rthkid-R4hotel').val() >= '1'  &&  $('.3rdkid-R4hotel').val() >= '1'  &&  $('.2kid-R4hotel').val() >= '1'  &&  $('.1stkid-R4	hotel').val() >= '1') ageDoneR4Hotel();
}
...
function re1l5HotelR4() {
	...
	else if ($('.5kid-R4hotel').val() >= '1'  &&  $('.4rthkid-R4hotel').val() >= '1'  &&  $('.3rdkid-R4hotel').val() >= '1'  &&  $('.2kid-R4hotel').val() >= '1'  &&  $('.1stkid-R4hotel').val() >= '1') ageDoneR4Hotel();
}
function re1l6HotelR4() {
	...
	else if ($('.6kid-R4hotel').val() >= '1'  &&  $('.5kid-R4hotel').val() >= '1'  &&  $('.4rthkid-R4hotel').val() >= '1'  &&  $('.3rdkid-R4hotel').val() >= '1'  &&  $('.2kid-R4hotel').val() >= '1'  &&  $('.1stkid-R4hotel').val() >= '1') ageDoneR4Hotel();
}
...
/*  Hotel Logic2 Room2*/
		...
		function agelogic2HotelR2() {
			if ($('.selec-Children-hotelR1').val() >= '2'  &  $('.1stkid-R2hotel').val() == '0') doAgeR2Hotel();
			else if ($('.selec-Children-hotelR1').val() == '2' &  $('.1stkid-R2hotel').val() >= '1' ) ageDoneR2Hotel();
		...
		function re2l4HotelR2() {
			...
			if ($('.4rthkid-R2hotel').val() == '0') doAgeR2Hotel();
			if ($('.3rdkid-R2hotel').val() == '0') doAgeR2Hotel();
			else if ($('.1stkid-R2hotel').val() >= '1'  &&  $('.3rdkid-R2hotel').val() >= '1' &&  $('.4rthkid-R2hotel').val() >= '1' ) ageDoneR2Hotel(); 
		...
		function re2l5HotelR2() {
			...
			if ($('.3rdkid-R2hotel').val() == '0') doAgeR2Hotel();
			if ($('.5kid-R2hotel').val() == '0') doAgeR2Hotel();
			else if ($('.5kid-R2hotel').val() >= '1' && $('.1stkid-R2hotel').val() >= '1'  &&  $('.3rdkid-R2hotel').val() >= '1' &&  $('.4rthkid-R2hotel').val() >= '1') ageDoneR2Hotel();
		}
		function re2l6HotelR2() {
			...
			if ($('.5kid-R2hotel').val() == '0') doAgeR2Hotel();
			if ($('.6kid-R2hotel').val() == '0') doAgeR2Hotel();
			else if ($('.6kid-R2hotel').val() >= '1' && $('.5kid-R2hotel').val() >= '1' && $('.1stkid-R2hotel').val() >= '1'  &&  $('.3rdkid-R2hotel').val() >= '1' &&  $('.4rthkid-R2hotel').val() >= '1') ageDoneR2Hotel();
		}
...
function agelogic2HotelR3() {
	if ($('.selec-Children-hotelR3').val() >= '2'  &  $('.1stkid-R3hotel').val() == '0') doAgeR3Hotel();
	else if ($('.selec-Children-hotelR3').val() == '2' &  $('.1stkid-R3hotel').val() >= '1' ) ageDoneR3Hotel();
...
function re2l4HotelR3() {
	...
	if ($('.4rthkid-R3hotel').val() == '0') doAgeR3Hotel();
	if ($('.3rdkid-R3hotel').val() == '0') doAgeR3Hotel();
	else if ($('.1stkid-R3hotel').val() >= '1'  &&  $('.3rdkid-R3hotel').val() >= '1' &&  $('.4rthkid-R3hotel').val() >= '1' ) ageDoneR3Hotel(); 
...
function re2l5HotelR3() {
	...
	if ($('.3rdkid-R3hotel').val() == '0') doAgeR3Hotel();
	if ($('.5kid-R3hotel').val() == '0') doAgeR3Hotel();
	else if ($('.5kid-R3hotel').val() >= '1' && $('.1stkid-R3hotel').val() >= '1'  &&  $('.3rdkid-R3hotel').val() >= '1' &&  $('.4rthkid-R3hotel').val() >= '1') ageDoneR3Hotel();
}
function re2l6HotelR3() {
	...
	if ($('.5kid-R3hotel').val() == '0') doAgeR3Hotel();
	if ($('.6kid-R3hotel').val() == '0') doAgeR3Hotel();
	else if ($('.6kid-R3hotel').val() >= '1' && $('.5kid-R3hotel').val() >= '1' && $('.1stkid-R3hotel').val() >= '1'  &&  $('.3rdkid-R3hotel').val() >= '1' &&  $('.4rthkid-R3hotel').val() >= '1') ageDoneR3Hotel();
}
...
function agelogic2HotelR4() {
	if ($('.selec-Children-hotelR4').val() >= '2'  &  $('.1stkid-R4hotel').val() == '0') doAgeR4Hotel();
	else if ($('.selec-Children-hotelR4').val() == '2' &  $('.1stkid-R4hotel').val() >= '1' ) ageDoneR4Hotel();
...
function re2l4HotelR4() {
	...
	if ($('.4rthkid-R4hotel').val() == '0') doAgeR4Hotel();
	if ($('.3rdkid-R4hotel').val() == '0') doAgeR4Hotel();
	else if ($('.1stkid-R4hotel').val() >= '1'  &&  $('.3rdkid-R4hotel').val() >= '1' &&  $('.4rthkid-R4hotel').val() >= '1' ) ageDoneR4Hotel(); 
...
function re2l5HotelR4() {
	...
	if ($('.3rdkid-R4hotel').val() == '0') doAgeR4Hotel();
	if ($('.5kid-R4hotel').val() == '0') doAgeR4Hotel();
	else if ($('.5kid-R4hotel').val() >= '1' && $('.1stkid-R4hotel').val() >= '1'  &&  $('.3rdkid-R4hotel').val() >= '1' &&  $('.4rthkid-R4hotel').val() >= '1') ageDoneR4Hotel();
}
function re2l6HotelR4() {
	...
	if ($('.5kid-R4hotel').val() == '0') doAgeR4Hotel();
	if ($('.6kid-R4hotel').val() == '0') doAgeR4Hotel();
	else if ($('.6kid-R4hotel').val() >= '1' && $('.5kid-R4hotel').val() >= '1' && $('.1stkid-R4hotel').val() >= '1'  &&  $('.3rdkid-R4hotel').val() >= '1' &&  $('.4rthkid-R4hotel').val() >= '1') ageDoneR4Hotel();
}
...
function agelogic3HotelR2() {
	if ($('.1stkid-R2hotel').val() == '0') doAgeR2Hotel();
	if ($('.2kid-R2hotel').val() == '0') doAgeR2Hotel();
	else if ($('.1stkid-R2hotel').val() >= '1'  &&  $('.2kid-R2hotel').val() >= '1') ageDoneR2Hotel();
...
function re3l4HotelR2() {
	...
	if ($('.2kid-R2hotel').val() == '0') doAgeR2Hotel();
	if ($('.4rthkid-R2hotel').val() == '0') doAgeR2Hotel();
	else if ($('.1stkid-R2hotel').val() >= '1'  &&  $('.2kid-R2hotel').val() >= '1'  &&   $('.4rthkid-R2hotel').val() >= '1') ageDoneR2Hotel();
...
function re3l5HotelR2() {
	...
	if ($('.4rthkid-R2hotel').val() == '0') doAgeR2Hotel();
	if ($('.5kid-R2hotel').val() == '0') doAgeR2Hotel();
	else if ($('.5kid-R2hotel').val() >= '1'  &&  $('.1stkid-R2hotel').val() >= '1'  &&  $('.2kid-R2hotel').val() >= '1'  &&   $('.4rthkid-R2hotel').val() >= '1') ageDoneR2Hotel();
}
...
function re3l6HotelR2() {
	...
	if ($('.5kid-R2hotel').val() == '0') doAgeR2Hotel();
	if ($('.6kid-R2hotel').val() == '0') doAgeR2Hotel();
	else if ($('.1stkid-R2hotel').val() >= '1'  &&  $('.2kid-R2hotel').val() >= '1'   &&     $('.4rthkid-R2hotel').val() >= '1'    &&  $('.5kid-R2hotel').val() >= '1' &&  $('6kid-R2hotel').val() >= '1' ) ageDoneR2Hotel();
...
function agelogic3HotelR3() {
	if ($('.1stkid-R3hotel').val() == '0') doAgeR3Hotel();
	if ($('.2kid-R3hotel').val() == '0') doAgeR3Hotel();
	else if ($('.1stkid-R3hotel').val() >= '1'  &&  $('.2kid-R3hotel').val() >= '1') ageDoneR3Hotel();
...
function re3l4HotelR3() {
	...
	if ($('.2kid-R3hotel').val() == '0') doAgeR3Hotel();
	if ($('.4rthkid-R3hotel').val() == '0') doAgeR3Hotel();
	else if ($('.1stkid-R3hotel').val() >= '1'  &&  $('.2kid-R3hotel').val() >= '1'  &&   $('.4rthkid-R3hotel').val() >= '1') ageDoneR3Hotel();
...
function re3l5HotelR3() {
	...
	if ($('.4rthkid-R3hotel').val() == '0') doAgeR3Hotel();
	if ($('.5kid-R3hotel').val() == '0') doAgeR3Hotel();
	else if ($('.5kid-R3hotel').val() >= '1'  &&  $('.1stkid-R3hotel').val() >= '1'  &&  $('.2kid-R3hotel').val() >= '1'  &&   $('.4rthkid-R3hotel').val() >= '1') ageDoneR3Hotel();
}
...
function re3l6HotelR3() {
	...
	if ($('.5kid-R3hotel').val() == '0') doAgeR3Hotel();
	if ($('.6kid-R3hotel').val() == '0') doAgeR3Hotel();
	else if ($('.1stkid-R3hotel').val() >= '1'  &&  $('.2kid-R3hotel').val() >= '1'   &&     $('.4rthkid-R3hotel').val() >= '1'    &&  $('.5kid-R3hotel').val() >= '1' &&  $('6kid-R3hotel').val() >= '1' ) ageDoneR3Hotel();
...
function agelogic3HotelR4() {
	if ($('.1stkid-R4hotel').val() == '0') doAgeR4Hotel();
	if ($('.2kid-R4hotel').val() == '0') doAgeR4Hotel();
	else if ($('.1stkid-R4hotel').val() >= '1'  &&  $('.2kid-R4hotel').val() >= '1') ageDoneR4Hotel();
...
function re3l4HotelR4() {
	...
	if ($('.2kid-R4hotel').val() == '0') doAgeR4Hotel();
	if ($('.4rthkid-R4hotel').val() == '0') doAgeR4Hotel();
	else if ($('.1stkid-R4hotel').val() >= '1'  &&  $('.2kid-R4hotel').val() >= '1'  &&   $('.4rthkid-R4hotel').val() >= '1') ageDoneR4Hotel();
...
function re3l5HotelR4() {
	...
	if ($('.4rthkid-R4hotel').val() == '0') doAgeR4Hotel();
	if ($('.5kid-R4hotel').val() == '0') doAgeR4Hotel();
	else if ($('.5kid-R4hotel').val() >= '1'  &&  $('.1stkid-R4hotel').val() >= '1'  &&  $('.2kid-R4hotel').val() >= '1'  &&   $('.4rthkid-R4hotel').val() >= '1') ageDoneR4Hotel();
}
...
function re3l6HotelR4() {
	...
	if ($('.5kid-R4hotel').val() == '0') doAgeR4Hotel();
	if ($('.6kid-R4hotel').val() == '0') doAgeR4Hotel();
	else if ($('.1stkid-R4hotel').val() >= '1'  &&  $('.2kid-R4hotel').val() >= '1'   &&     $('.4rthkid-R4hotel').val() >= '1'    &&  $('.5kid-R4hotel').val() >= '1' &&  $('6kid-R4hotel').val() >= '1' ) ageDoneR4Hotel();
...
function agelogic4HotelR2() {
	...
	if ($('.2kid-R2hotel').val() == '0') doAgeR2Hotel();
	if ($('.3rdkid-R2hotel').val() == '0') doAgeR2Hotel();
	else if ($('.1stkid-R2hotel').val() >= '1'  &&  $('.2kid-R2hotel').val() >= '1'  &&  $('.3rdkid-R2hotel').val() >= '1') ageDoneR2Hotel();
...
function re4l5HotelR2() {
	...
	if ($('.3rdkid-R2hotel').val() == '0') doAgeR2Hotel();
	if ($('.5kid-R2hotel').val() == '0') doAgeR2Hotel();
	else if ($('.5kid-R2hotel').val() >= '1'  &&  $('.1stkid-R2hotel').val() >= '1'  &&  $('.2kid-R2hotel').val() >= '1'  &&   $('.3rdkid-R2hotel').val() >= '1') ageDoneR2Hotel();
...
function re4l6HotelR2() {
	...
	if ($('.5kid-R2hotel').val() == '0') doAgeR2Hotel();
	if ($('.6kid-R2hotel').val() == '0') doAgeR2Hotel();
	else if ($('6kid-R2hotel').val() >= '1'  &&  $('.5kid-R2hotel').val() >= '1'  &&  $('.1stkid-R2hotel').val() >= '1'  &&  $('.2kid-R2hotel').val() >= '1'  &&   $('.3rdkid-R2hotel').val() >= '1') ageDoneR2Hotel();
}
...
function agelogic4HotelR3() {
	...
	if ($('.2kid-R3hotel').val() == '0') doAgeR3Hotel();
	if ($('.3rdkid-R3hotel').val() == '0') doAgeR3Hotel();
	else if ($('.1stkid-R3hotel').val() >= '1'  &&  $('.2kid-R3hotel').val() >= '1'  &&  $('.3rdkid-R3hotel').val() >= '1') ageDoneR3Hotel();
...
function re4l5HotelR3() {
	...
	if ($('.3rdkid-R3hotel').val() == '0') doAgeR3Hotel();
	if ($('.5kid-R3hotel').val() == '0') doAgeR3Hotel();
	else if ($('.5kid-R3hotel').val() >= '1'  &&  $('.1stkid-R3hotel').val() >= '1'  &&  $('.2kid-R3hotel').val() >= '1'  &&   $('.3rdkid-R3hotel').val() >= '1') ageDoneR3Hotel();
...
function re4l6HotelR3() {
	...
	if ($('.5kid-R3hotel').val() == '0') doAgeR3Hotel();
	if ($('.6kid-R3hotel').val() == '0') doAgeR3Hotel();
	else if ($('6kid-R3hotel').val() >= '1'  &&  $('.5kid-R3hotel').val() >= '1'  &&  $('.1stkid-R3hotel').val() >= '1'  &&  $('.2kid-R3hotel').val() >= '1'  &&   $('.3rdkid-R3hotel').val() >= '1') ageDoneR3Hotel();
}
...
function agelogic4HotelR4() {
	...
	if ($('.2kid-R4hotel').val() == '0') doAgeR4Hotel();
	if ($('.3rdkid-R4hotel').val() == '0') doAgeR4Hotel();
	else if ($('.1stkid-R4hotel').val() >= '1'  &&  $('.2kid-R4hotel').val() >= '1'  &&  $('.3rdkid-R4hotel').val() >= '1') ageDoneR4Hotel();
...
function re4l5HotelR4() {
	...
	if ($('.3rdkid-R4hotel').val() == '0') doAgeR4Hotel();
	if ($('.5kid-R4hotel').val() == '0') doAgeR4Hotel();
	else if ($('.5kid-R4hotel').val() >= '1'  &&  $('.1stkid-R4hotel').val() >= '1'  &&  $('.2kid-R4hotel').val() >= '1'  &&   $('.3rdkid-R4hotel').val() >= '1') ageDoneR4Hotel();
...
function re4l6HotelR4() {
	...
	if ($('.5kid-R4hotel').val() == '0') doAgeR4Hotel();
	if ($('.6kid-R4hotel').val() == '0') doAgeR4Hotel();
	else if ($('6kid-R4hotel').val() >= '1'  &&  $('.5kid-R4hotel').val() >= '1'  &&  $('.1stkid-R4hotel').val() >= '1'  &&  $('.2kid-R4hotel').val() >= '1'  &&   $('.3rdkid-R4hotel').val() >= '1') ageDoneR4Hotel();
}
...
function agelogic5HotelR2() {
	...
	if ($('.3rdkid-R2hotel').val() == '0') doAgeR2Hotel();
	if ($('.4rthkid-R2hotel').val() == '0') doAgeR2Hotel();
	else if ( $('.1stkid-R2hotel').val() >= '1'  &&  $('.2kid-R2hotel').val() >= '1'  &&   $('.3rdkid-R2hotel').val() >= '1'  &&  $('.4rthkid-R2hotel').val() >= '1'  ) ageDoneR2Hotel();
...
function re5l6HotelR2() {
	...
	if ($('.4rthkid-R2hotel').val() == '0') doAgeR2Hotel();
	if ($('.6kid-R2hotel').val() == '0') doAgeR2Hotel();
	else if ( $('.1stkid-R2hotel').val() >= '1'  &&  $('.2kid-R2hotel').val() >= '1'  &&   $('.3rdkid-R2hotel').val() >= '1'  &&  $('.4rthkid-R2hotel').val() >= '1'  &&  $('6kid-R2hotel').val() >= '1' ) ageDoneR2Hotel();
}
...
function agelogic5HotelR3() {
	...
	if ($('.3rdkid-R3hotel').val() == '0') doAgeR3Hotel();
	if ($('.4rthkid-R3hotel').val() == '0') doAgeR3Hotel();
	else if ( $('.1stkid-R3hotel').val() >= '1'  &&  $('.2kid-R3hotel').val() >= '1'  &&   $('.3rdkid-R3hotel').val() >= '1'  &&  $('.4rthkid-R3hotel').val() >= '1'  ) ageDoneR3Hotel();
...
function re5l6HotelR3() {
	...
	if ($('.4rthkid-R3hotel').val() == '0') doAgeR3Hotel();
	if ($('.6kid-R3hotel').val() == '0') doAgeR3Hotel();
	else if ( $('.1stkid-R3hotel').val() >= '1'  &&  $('.2kid-R3hotel').val() >= '1'  &&   $('.3rdkid-R3hotel').val() >= '1'  &&  $('.4rthkid-R3hotel').val() >= '1'  &&  $('6kid-R3hotel').val() >= '1' ) ageDoneR3Hotel();
}
...
function agelogic5HotelR4() {
	...
	if ($('.3rdkid-R4hotel').val() == '0') doAgeR4Hotel();
	if ($('.4rthkid-R4hotel').val() == '0') doAgeR4Hotel();
	else if ( $('.1stkid-R4hotel').val() >= '1'  &&  $('.2kid-R4hotel').val() >= '1'  &&   $('.3rdkid-R4hotel').val() >= '1'  &&  $('.4rthkid-R4hotel').val() >= '1'  ) ageDoneR4Hotel();
...
function re5l6HotelR4() {
	...
	if ($('.4rthkid-R4hotel').val() == '0') doAgeR4Hotel();
	if ($('.6kid-R4hotel').val() == '0') doAgeR4Hotel();
	else if ( $('.1stkid-R4hotel').val() >= '1'  &&  $('.2kid-R4hotel').val() >= '1'  &&   $('.3rdkid-R4hotel').val() >= '1'  &&  $('.4rthkid-R4hotel').val() >= '1'  &&  $('6kid-R4hotel').val() >= '1' ) ageDoneR4Hotel();
}
...
function agelogic6HotelR2() {
	...
	if ($('.4rthkid-R2hotel').val() == '0') doAgeR2Hotel();
	if ($('.5kid-R2hotel').val() == '0') doAgeR2Hotel();
	else if ($('.1stkid-R2hotel').val() >= '1'  &&  $('.2kid-R2hotel').val() >= '1'  &&   $('.3rdkid-R2hotel').val() >= '1' &&  $('.4rthkid-R2hotel').val() >= '1'  &&   $('.5kid-R2hotel').val() >= '1') ageDoneR2Hotel();
...
function agelogic6HotelR3() {
	...
	if ($('.4rthkid-R3hotel').val() == '0') doAgeR3Hotel();
	if ($('.5kid-R3hotel').val() == '0') doAgeR3Hotel();
	else if ($('.1stkid-R3hotel').val() >= '1'  &&  $('.2kid-R3hotel').val() >= '1'  &&   $('.3rdkid-R3hotel').val() >= '1' &&  $('.4rthkid-R3hotel').val() >= '1'  &&   $('.5kid-R3hotel').val() >= '1') ageDoneR3Hotel();
...
function agelogic6HotelR4() {
	...
	if ($('.4rthkid-R4hotel').val() == '0') doAgeR4Hotel();
	if ($('.5kid-R4hotel').val() == '0') doAgeR4Hotel();
	else if ($('.1stkid-R4hotel').val() >= '1'  &&  $('.2kid-R4hotel').val() >= '1'  &&   $('.3rdkid-R4hotel').val() >= '1' &&  $('.4rthkid-R4hotel').val() >= '1'  &&   $('.5kid-R4hotel').val() >= '1') ageDoneR4Hotel();
